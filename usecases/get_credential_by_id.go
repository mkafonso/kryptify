...
func (c *GetCredentialByID) Execute(ctx context.Context, data *GetCredentialByIDRequest) (*GetCredentialByIDResponse, error) {
	...
	credential, err := c.credentialRepo.GetCredentialByID(ctx, data.TargetCredentialID)
	if err != nil {
